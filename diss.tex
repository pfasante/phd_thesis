...
\begin{document}
\frontmatter{}
\newgeometry{inner=24mm, outer=79mm, top=27.4mm, bottom=27.4mm}
...
\blankpage{}
\input{frontbackmatter/zusammenfassung}
\blankpage{}
...
%\chapter*{Todos}\addcontentsline{toc}{chapter}{Todos}
%\itodo{%
%Copyright Notes
%
%Publishing / printing history
%
%Country where printed
%
%ISBN and or CIP information
%}
%
...
%\itodo{Update \cref{st:tab:results2} with clyde and shadow}
...
%\begin{appendix}
%
%\input{frontbackmatter/appendix-bison}
%\input{frontbackmatter/appendix-slps}
%\input{frontbackmatter/appendix-subspacetrails}
%
%\end{appendix}
\end{fullwidth}
